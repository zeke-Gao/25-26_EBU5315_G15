...
function loadUiPrefs() {
  try {
    ...
    if (!raw) return { themeMode: 'bright', colorMode: 'standard', fontScale: 'standard' };
    const parsed = JSON.parse(raw);
    ...
    return { themeMode: 'bright', colorMode: 'standard', fontScale: 'standard' };
  }
}
...
if (homeBtn) {
  homeBtn.addEventListener('click', () => {
    window.location.href = lang === 'zh' ? '../HomePage/index-zh.html' : '../HomePage/index.html';
  });
}
